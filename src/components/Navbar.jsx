...
import { IoIosInformationCircleOutline, IoMdSettings, IoMdLogIn } from 'react-icons/io';
import { HiMenu, HiX } from 'react-icons/hi';

const Nav_Items = [
  { id: 1, icon: MdDashboard, name: 'Dashboard', link: '/dashboard' },
  { id: 2, icon: CiMail, name: 'Contact Us', link: '/contact-us' },
  { id: 3, icon: IoIosInformationCircleOutline, name: 'About Us', link: '/about-us' },
  { id: 4, icon: IoMdSettings, name: 'Settings', link: '/settings' },
  { id: 5, icon: IoMdLogIn, name: 'Login', link: '/login' },
];
